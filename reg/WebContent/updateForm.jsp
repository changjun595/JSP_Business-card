...
<body bgcolor="<%=bodyback_c%>">
  ...
  %>
  <form name="insForm" method="post" action="updateForm_Ok.jsp" onsubmit="return inputCheck()">
    <table width="650" height="350" border="0" cellspacing="0" cellpadding="2"  align="center">
      ...
      <tr> 
        ...
        <td colspan="2" width="200" bgcolor="<%=value_c%>"> 
		  <input type="text" name="name" maxlength="10" value="<%=regBean.getName() %>"
      ...
      <tr> 
        ...
        <td colspan="2" width="200" bgcolor="<%=value_c%>"> 
		  <input type="text" name="company" maxlength="30" value="<%=regBean.getCompany() %>"
		  	width="200" bgcolor="<%=value_c%>" autocomplete="off" style="font-size: 22px;"></td>
      </tr>
      <tr> 
        <td width="100" bgcolor="<%=title_c%>" align="center" style="font-size: 22px;"><b>직책</b></td>
        <td colspan="2" width="200" bgcolor="<%=value_c%>"> 
		  <input type="text" name="position" maxlength="30" value="<%=regBean.getPosition() %>"
		  	width="200" bgcolor="<%=value_c%>" autocomplete="off" style="font-size: 22px;"></td>
      </tr>
      <tr> 
        <td width="100" bgcolor="<%=title_c%>" align="center" style="font-size: 22px;"><b>연락처</b></td>
        <td colspan="2" width="200" bgcolor="<%=value_c%>"> 
		  <input type="text" name="tell" maxlength="50" value="<%=regBean.getTell() %>"
		  	width="200" bgcolor="<%=value_c%>" autocomplete="off" style="font-size: 22px;"></td>
      </tr>
      <tr> 
        <td width="100" bgcolor="<%=title_c%>" align="center" style="font-size: 22px;"><b>메일</b></td>
        <td colspan="2" width="200" bgcolor="<%=value_c%>"> 
		  <input type="text" name="email" maxlength="100" value="<%=regBean.getEmail() %>"
		  	width="200" bgcolor="<%=value_c%>" autocomplete="off" style="font-size: 22px;"></td>
      </tr>
      <tr> 
        <td width="100" bgcolor="<%=title_c%>" align="center" style="font-size: 22px;"><b>주소</b></td>
        <td colspan="2" width="200" bgcolor="<%=value_c%>"> 
		  <input type="text" name="address" maxlength="100" value="<%=regBean.getAddress() %>"
		  	width="200" bgcolor="<%=value_c%>" autocomplete="off" style="font-size: 22px;"></td>
      </tr>
      <tr> 
